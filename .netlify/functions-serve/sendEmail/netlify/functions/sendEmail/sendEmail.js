...
// netlify/functions/sendEmail/sendEmail.js
...
async function handler(event) {
  if (event.httpMethod === "POST") {
    ...
    const formattedBirthdate = (0, import_dayjs.default)(birthdate).format("DD/MM/YYYY");
    ...
    try {
      ...
      return {
        statusCode: 200,
        body: JSON.stringify({ message: "E-posta ba\u015Far\u0131yla g\xF6nderildi" })
      };
    } catch (error) {
      console.error("E-posta g\xF6nderme hatas\u0131:", error);
      return {
        statusCode: 500,
        body: JSON.stringify({ message: "E-posta g\xF6nderme s\u0131ras\u0131nda hata olu\u015Ftu" })
      };
    }
  }
  return {
    statusCode: 405,
    body: JSON.stringify({ message: "Y\xF6ntem Desteklenmiyor" })
  };
}
